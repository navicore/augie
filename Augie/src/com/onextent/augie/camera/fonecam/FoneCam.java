...
public class FoneCam implements AugCamera {
    ...
    public FoneCam(int id, CodeableName cameraname, String name) {
   
        this.cname = cameraname;
        this.name = name;
        //if no valid id, the camera will be created by setCode(code)
        if (id >= 0) augcamera = AbstractFoneCam.getInstance(id);
    }
    ...
    public void setCode(Code code) throws CodeableException {
        ...
        augcamera = AbstractFoneCam.getInstance(id);
        if (augcamera == null) {
    ...
    public void startFaceDetection() {
        augcamera.startFaceDetection();
    }

    @Override
    public void stopFaceDetection() {
        augcamera.stopFaceDetection();
    }
